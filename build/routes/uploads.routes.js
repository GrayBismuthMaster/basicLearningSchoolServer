...
var uploadsController = _interopRequireWildcard(require("../controllers/uploads.controller"));
...
router.post('/profile', upload.single('avatar'), uploadsController.uploadProfile); //Petición get para el error 404
